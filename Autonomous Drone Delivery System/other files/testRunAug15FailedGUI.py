    ...
    with SyncCrazyflie(URI, cf=Crazyflie(rw_cache='./cache')) as scf:
        ...
        with MotionCommander(scf, default_height=DEFAULT_HEIGHT) as mc:
            ...
            while True:
                ...
                thequeue.put((thread_frame, thread_data))
...
def guiCode():
    ...
    if not thequeue.empty():
        thread_frame, thread_data = thequeue.get()
        time.sleep(0.01)
    else:
        thread_frame, thread_data = None, None
    """
...
if __name__ == "__main__":
    ...
    t1 = threading.Thread(target = mainCode, daemon=True)
