            ...
            while True:
                ...
                if retVal == None:
                    ...
                    if verticalOffset == 0 and horizontalOffset == 0:
                        print("COMPLETELY CENTERED BITCH")
                        ...
                        while (not horiCentered) and (not vertCentered):
                            ...
                            frame = decoded
                            print("frame returned")
                            """END OF CAMERA SECOND CODE"""
                            
                            cv2.circle(frame, frameCenter, 3, (0, 255, 0), 1)

                            cv2.line(frame, tl, tr, (255, 255, 255), 2)
                            cv2.line(frame, tr, br, (255, 255, 255), 2)
                            cv2.line(frame, br, bl, (255, 255, 255), 2)
                            cv2.line(frame, bl, tl, (255, 255, 255), 2)
                            cv2.imshow("frame", frame)
                            cv2.waitKey(1)

                            retval = droneCV2.detect_aruco(frame)
                            if retval == None:
                                print("While in centering loop: Aruco not detected")
